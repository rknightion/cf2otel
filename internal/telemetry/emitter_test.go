...
func TestEmitterExportsMetricMetadataAndDurationBuckets(t *testing.T) {
	...
	for _, record := range []struct {
		...
		{semconv.MetricKVStorageKeys, 3, "gauge"},
		{semconv.MetricR2StorageObjects, 4, "gauge"},
		{semconv.MetricQueuesBacklogMessages, 5, "gauge"},
		{semconv.MetricQueuesDelayedBacklogMessages, 6, "gauge"},
		{semconv.MetricQueuesConsumerConcurrency, 2, "gauge"},
	...
	for _, want := range []struct{ name, unit string }{
		...
		{semconv.MetricKVStorageKeys, "{key}"},
		{semconv.MetricR2StorageObjects, "{object}"},
		{semconv.MetricQueuesBacklogMessages, "{message}"},
		{semconv.MetricQueuesDelayedBacklogMessages, "{message}"},
		{semconv.MetricQueuesConsumerConcurrency, "{consumer}"},
