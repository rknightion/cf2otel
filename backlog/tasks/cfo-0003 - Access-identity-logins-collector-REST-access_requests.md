...
- [ ] #4 Metrics: the Groups-derived cloudflare.access.logins by app, allowed, identity provider and login type, plus a REST-derived exact counter cloudflare.access.identity_logins by app, allowed, connection and action; neither carries email, IP, path or ray attributes, and both are listed in docs/signals.md
<!-- AC:END -->
